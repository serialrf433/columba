package network.columba.app.initialization
...
import network.columba.app.IInitializationCallback
import network.columba.app.IReticulumService
 ...
 * 1. Main app process (network.columba.app) - Expected behavior
 * 2. Service process (network.columba.app:reticulum) - BUG: Should NOT auto-initialize
 *
 * This causes:
